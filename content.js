...
const BLOCKS = [
 {name:"Dimensions.com", category:"CAD Blocks", what:"A collection of dimensional drawings, human figures, furniture, fixtures and architectural elements.", why:"Useful for finding ready-made CAD blocks and dimensional references for drawings and plans.", who:"All years, especially AutoCAD users.", link:"http://dimensions.com/", student:"Almaha Al-Elyani"},
 {name:"BIMobject", category:"3D Models / BIM", what:"A library of manufacturer-specific BIM and 3D models for architecture and interior design.", why:"Useful for finding real products and downloadable models for Revit and other design software.", who:"All years, especially Revit users.", link:"https://www.bimobject.com/en", student:"Almaha Al-Elyani"},
 {name:"CGTrader", category:"3D Models", what:"A large marketplace and library of 3D models in formats used across visualization and design software.", why:"Helps students find ready-made 3D assets for rendering and visualization.", who:"All years using 3D software.", link:"https://www.cgtrader.com/free-3d-models", student:"Almaha Al-Elyani"},
 {name:"SketchUp Texture", category:"Textures & Materials", what:"A library of textures and material resources for SketchUp and architectural visualization.", why:"Useful for adding realistic materials and surface finishes to design visualizations.", who:"All years using SketchUp.", link:"http://sketchuptexture.com/", student:"Almaha Al-Elyani"},
 {name:"3D Warehouse", category:"3D Models", what:"SketchUp's model-sharing platform with furniture, fixtures, buildings and site elements.", why:"Speeds up modeling and interior studies without creating every object from scratch.", who:"All years using SketchUp.", link:"http://3dwarehouse.sketchup.com/", student:"Almaha Al-Elyani"},
 {name:"3Dfindit", category:"CAD / BIM Models", what:"A search platform for manufacturer-specific CAD, BIM and 3D product models.", why:"Useful for finding accurate product models and technical files for design projects.", who:"All years, especially during detailed design and specification.", link:"https://www.3dfindit.com/en/", student:"Almaha Al-Elyani"},
 {name:"1miba", category:"3D Models", what:"A collection of downloadable 3D models and design assets.", why:"Provides additional ready-made models for visualization and design work.", who:"All years using 3D software.", link:"https://1miba.com/", student:"Almaha Al-Elyani"},
 {name:"3DBrute", category:"3D Models", what:"A library of downloadable 3D models for architectural visualization and design.", why:"Useful when students need additional assets for renders and presentation images.", who:"All years using 3D software.", link:"https://3dbrute.com", student:"Almaha Al-Elyani"},
 {name:"DWGmodels", category:"CAD Blocks", what:"A library of downloadable DWG drawings and CAD blocks for architecture and design.", why:"Useful for finding ready-made blocks that can speed up technical drawings and plans.", who:"All years, especially AutoCAD users.", link:"http://dwgmodels.com/", student:"Almaha Al-Elyani"},
 {name:"Free3D", category:"3D Models", what:"A library of free 3D models available in formats used by different visualization programs.", why:"Useful for finding additional assets for rendering and 3D visualization.", who:"All years using 3D software.", link:"https://free3d.io/#gsc.tab=0", student:"Almaha Al-Elyani"},
];
const COURSES = [
